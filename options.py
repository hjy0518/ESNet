...
parser.add_argument('--load1', type=str, default='mobilenetv2_1.0-0c6065bc.pth', help='train from checkpoints')
parser.add_argument('--load_pre', type=str, default='./cpts/best.pth', help='train from checkpoints')
